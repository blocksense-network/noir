    ...
    B: BlackBoxFunctionSolver<FieldElement> + Default,
{
    ...
    let acir_program =
        compile_no_check(context, &acir_config, fuzzing_harness.get_id(), None, false, false, false);
    ...
    let brillig_program =
        compile_no_check(context, &brillig_config, fuzzing_harness.get_id(), None, false, false, false);
